...
export type CultivosTab = "cultivos" | "historial";
...
export default function PillToggle({
    ...
    value: CultivosTab;
    onChange: (v: CultivosTab) => void;
}) {
    const options = [
        { value: "cultivos" as const, icon: LayoutGrid, label: "Cultivos" },
        { value: "historial" as const, icon: Table, label: "Historial" },
    ];
