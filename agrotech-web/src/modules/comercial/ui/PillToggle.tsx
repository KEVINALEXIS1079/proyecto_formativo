...
import { DollarSign, Users, Package, Wheat } from "lucide-react";

export type ComercialTab = "ventas" | "clientes" | "productos" | "lotes";
...
export default function PillToggle({
    ...
    value: ComercialTab;
    onChange: (v: ComercialTab) => void;
}) {
    const options = [
        { value: "ventas" as const, icon: DollarSign, label: "Ventas" },
        { value: "clientes" as const, icon: Users, label: "Clientes" },
        { value: "productos" as const, icon: Package, label: "Productos" },
        { value: "lotes" as const, icon: Wheat, label: "Lotes" },
    ];
