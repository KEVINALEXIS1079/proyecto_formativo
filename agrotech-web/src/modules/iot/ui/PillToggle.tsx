...
interface PillToggleProps {
    ...
    onChange: (value: "dashboard" | "analytics") => void;
}

export default function PillToggle({ value, onChange }: PillToggleProps) {
    const options = [
        { value: "dashboard" as const, icon: LayoutDashboard, label: "Tablero" },
        { value: "analytics" as const, icon: BarChart3, label: "Analítica de Lotes" },
    ];
