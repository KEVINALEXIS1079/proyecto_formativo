...
import { List, Map as MapIcon, Edit, MapPin, Ruler } from "lucide-react";
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="flex items-center gap-1.5 text-gray-700 dark:text-gray-300">
                                            ...
                                            <span className="font-medium text-xs">
                                                {(() => {
                                                    ...
                                                    const lat = lote.coordenadas_lote.reduce((sum, c) => sum + c.latitud_lote, 0) / lote.coordenadas_lote.length;
                                                    const lng = lote.coordenadas_lote.reduce((sum, c) => sum + c.longitud_lote, 0) / lote.coordenadas_lote.length;
                                                    return (
                                                        <div className="flex flex-col">
                                    ...
                                    <div className="col-span-2 space-y-1 border-t border-gray-100 dark:border-gray-800 pt-2 mt-1">
                                        ...
                                        <div className="flex items-center gap-1.5 text-gray-700 dark:text-gray-300">
                                            ...
                                            <span className="font-medium">{lote.sublotes.length} registrados</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
