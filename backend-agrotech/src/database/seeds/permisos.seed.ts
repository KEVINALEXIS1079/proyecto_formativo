...
export async function seedPermisos(dataSource: DataSource) {
  ...
  const permisosBase = [
    ...
    },
    {
      modulo: 'usuarios',
      accion: 'ver_permisos',
      clave: 'usuarios.ver_permisos',
      descripcion: 'Ver permisos de usuarios',
    },
    {
      modulo: 'usuarios',
      accion: 'asignar_permisos',
      clave: 'usuarios.asignar_permisos',
      descripcion: 'Asignar permisos a usuarios',
    },
    {
      modulo: 'usuarios',
      accion: 'ver_perfil',
      clave: 'usuarios.ver_perfil',
      descripcion: 'Permite ver el perfil de usuarios individuales',
    },
    ...
    // Sublotes
    {
      ...
      accion: 'ver',
      clave: 'sublotes.ver',
      descripcion: 'Ver sublotes',
    },
    {
      modulo: 'sublotes',
      accion: 'crear',
      clave: 'sublotes.crear',
      descripcion: 'Crear sublotes',
    },
    {
      modulo: 'sublotes',
      accion: 'editar',
      clave: 'sublotes.editar',
      descripcion: 'Editar sublotes',
    },
    {
      modulo: 'sublotes',
      accion: 'eliminar',
      clave: 'sublotes.eliminar',
      descripcion: 'Eliminar sublotes',
    },
    ...
    // Cultivos
    {
      ...
      accion: 'ver',
      clave: 'cultivos.ver',
      descripcion: 'Ver cultivos',
    },
    {
      modulo: 'cultivos',
      accion: 'crear',
      clave: 'cultivos.crear',
      descripcion: 'Crear cultivos',
    },
    {
      modulo: 'cultivos',
      accion: 'editar',
      clave: 'cultivos.editar',
      descripcion: 'Editar cultivos',
    },
    {
      modulo: 'cultivos',
      accion: 'eliminar',
      clave: 'cultivos.eliminar',
      descripcion: 'Eliminar cultivos',
    },
    ...
    // Actividades
    {
      modulo: 'actividades',
      accion: 'ver',
      clave: 'actividades.ver',
      descripcion: 'Ver actividades',
    },
    {
      modulo: 'actividades',
      accion: 'crear',
      clave: 'actividades.crear',
      descripcion: 'Crear actividades',
    },
    {
      modulo: 'actividades',
      accion: 'editar',
      clave: 'actividades.editar',
      descripcion: 'Editar actividades',
    },
    {
      modulo: 'actividades',
      accion: 'eliminar',
      clave: 'actividades.eliminar',
    ...
    },
    {
      modulo: 'inventario',
      accion: 'crear',
      clave: 'inventario.crear',
      descripcion: 'Crear insumos',
    },
    {
      modulo: 'inventario',
      accion: 'editar',
      clave: 'inventario.editar',
      descripcion: 'Editar insumos',
    },
    {
      modulo: 'inventario',
      accion: 'eliminar',
      clave: 'inventario.eliminar',
    ...
    // IoT
    {
      ...
      accion: 'ver',
      clave: 'iot.ver',
      descripcion: 'Ver sensores y lecturas',
    },
    {
      modulo: 'iot',
      accion: 'crear',
      clave: 'iot.crear',
      descripcion: 'Crear sensores',
    },
    {
      modulo: 'iot',
      accion: 'editar',
      clave: 'iot.editar',
      descripcion: 'Editar sensores',
    },
    {
      modulo: 'iot',
      accion: 'eliminar',
      clave: 'iot.eliminar',
      descripcion: 'Eliminar sensores',
    },
    ...
    // Producción
    {
      modulo: 'produccion',
      accion: 'ver',
      clave: 'produccion.ver',
      descripcion: 'Ver producción',
    },
    {
      modulo: 'produccion',
      accion: 'crear',
    ...
    // Wiki
    {
      ...
      accion: 'ver',
      clave: 'wiki.ver',
      descripcion: 'Ver wiki',
    },
    {
      modulo: 'wiki',
      accion: 'crear',
      clave: 'wiki.crear',
      descripcion: 'Crear entradas wiki',
    },
    {
      modulo: 'wiki',
      accion: 'editar',
      clave: 'wiki.editar',
      descripcion: 'Editar entradas wiki',
    },
    {
      modulo: 'wiki',
      accion: 'eliminar',
      clave: 'wiki.eliminar',
      descripcion: 'Eliminar entradas wiki',
    },
    ...
    // Finanzas
    {
      ...
      accion: 'ver',
      clave: 'finanzas.ver',
      descripcion: 'Ver transacciones financieras',
    },
    {
      modulo: 'finanzas',
      accion: 'crear',
      clave: 'finanzas.crear',
      descripcion: 'Crear transacciones financieras',
    },
    {
      modulo: 'finanzas',
      accion: 'editar',
      clave: 'finanzas.editar',
      descripcion: 'Editar transacciones financieras',
    },
    {
      modulo: 'finanzas',
      accion: 'eliminar',
      clave: 'finanzas.eliminar',
    ...
    // Usuarios extra
    {
      modulo: 'usuarios',
      accion: 'cambiar_rol',
      clave: 'usuarios.cambiar_rol',
      descripcion: 'Cambiar rol de usuarios',
    },
  ];
  ...
  for (const permisoData of permisosBase) {
    const existing = await permisoRepo.findOne({
  ...
  if (permisosAsignados > 0) {
    console.log(
      `  ${permisosAsignados} permisos asignados al rol Administrador`,
    );
  } else {
  ...
  const verPerfilPermiso = await permisoRepo.findOne({
    where: { clave: 'usuarios.ver_perfil' },
  });
  if (verPerfilPermiso) {
    ...
    if (permisosAsignadosGlobal > 0) {
      console.log(
        `  ${permisosAsignadosGlobal} asignaciones de permiso usuarios.ver_perfil realizadas`,
      );
    } else {
      console.log(
        '  ℹPermiso usuarios.ver_perfil ya asignado a todos los roles',
      );
    }
  } else {
